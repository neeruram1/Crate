  ...
  <div>
    ...
    <Grid>
      <GridCell style={{ textAlign: "center" }}>
        ...
        <H3 font="secondary">
          Page you are looking for does not exists or has removed. It's 404.
        </H3>

        <p style={{ marginTop: "2em" }}>What can you do?</p>

        <p style={{ marginTop: "0.5em" }}>
          You can go to <Link to={home.home.path}>home page.</Link> or contact
          us for any help.
        </p>
      </GridCell>
    </Grid>
...
// sad path if we go to a non existent route
